...
const TOOLS = [
    ...
    },
    {
        ...
        description: "Search Finanstilsynet enforcement actions — administrative fines, licence revocations, public warnings.",
        inputSchema: {
            type: "object",
            properties: {
                query: {
    ...
    try {
        switch (name) {
            ...
            case "no_fin_get_regulation": {
                ...
                return textContent({
                    ...p,
                    _citation: buildCitation(String(p.reference ?? parsed.reference), String(p.title ?? p.reference ?? parsed.reference), "no_fin_get_regulation", { sourcebook: parsed.sourcebook, reference: parsed.reference }),
                });
            }
